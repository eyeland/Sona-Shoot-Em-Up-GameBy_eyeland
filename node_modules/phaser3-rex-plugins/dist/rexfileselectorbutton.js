(function (global, factory) {
  ...
  */
  ...
  Object.assign(LabelBase.prototype, methods$1);
    ...
    function Label(scene, config) {
      ...
      if (icon) {
        ...
        if (!fitRatio) {
          ...
          _this.setIconSize(GetValue$2(config, 'iconWidth', iconSize), GetValue$2(config, 'iconHeight', iconSize));
        }
      }
      if (text) {
      ...
      if (action) {
        ...
        if (!fitRatio) {
          ...
          _this.setActionSize(GetValue$2(config, 'actionWidth', actionSize), GetValue$2(config, 'actionHeight', actionSize));
        }
      }
  ...
  var FileChooser = /*#__PURE__*/function (_DOMElement) {
    ...
    function FileChooser(scene, x, y, width, height, config) {
      ...
      _this.setCloseDelay(GetValue$1(config, 'closeDelay', 200));
  ...
  var FileSelectorButton = /*#__PURE__*/function (_Label) {
    ...
    var _super = _createSuper(FileSelectorButton);
    function FileSelectorButton(scene, config) {
      ...
      _this.setAccept(GetValue(config, 'accept', ''));
      _this.setMultiple(GetValue(config, 'multiple', false));
