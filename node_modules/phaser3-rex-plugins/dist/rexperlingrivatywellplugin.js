(function (global, factory) {
  ...
  var PERIOD_SCALE = 1 / 5000;
  var ROTATE_SCALE = 0.3;
  var PerlinGrivatyWell = /*#__PURE__*/function () {
    function PerlinGrivatyWell(config) {
      _classCallCheck(this, PerlinGrivatyWell);
      this.active = true;
    ...
    _createClass(PerlinGrivatyWell, [{
      key: "update",
      value: function update(particle, delta) {
        var period = delta * this.periodScale;
        var noiseValue = this.noise.perlin2(particle.x * period, particle.y * period); // -1 ~ 1

        var noiseAngle = noiseValue * Math.PI; // -PI ~ PI
        this.velocity.set(particle.velocityX, particle.velocityY).rotate(noiseAngle * this.rotateScale);
        particle.velocityX = this.velocity.x;
        particle.velocityY = this.velocity.y;
      }
    }]);
    return PerlinGrivatyWell;
  }();

  var PerlinGrivatyWellPlugin = /*#__PURE__*/function (_Phaser$Plugins$BaseP) {
    _inherits(PerlinGrivatyWellPlugin, _Phaser$Plugins$BaseP);
    var _super = _createSuper(PerlinGrivatyWellPlugin);
    function PerlinGrivatyWellPlugin(pluginManager) {
      _classCallCheck(this, PerlinGrivatyWellPlugin);
      return _super.call(this, pluginManager);
    }
    _createClass(PerlinGrivatyWellPlugin, [{
      key: "start",
