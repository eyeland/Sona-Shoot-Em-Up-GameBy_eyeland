(function (global, factory) {
  ...
  var SetAcceleration = function SetAcceleration(gameObject, ax, ay, onChange) {
  ...
  var SetAngularVelocity = function SetAngularVelocity(gameObject, av, onChange) {
    var body = gameObject.body;
  ...
  var Ship = /*#__PURE__*/function (_TickTask) {
    _inherits(Ship, _TickTask);
    var _super = _createSuper(Ship);
    function Ship(gameObject, config) {
      var _this;
    ...
    _createClass(Ship, [{
      ...
      key: "setTurnSpeed",
      value: function setTurnSpeed(angularVelocity) {
  ...
  var ShipPlugin = /*#__PURE__*/function (_Phaser$Plugins$BaseP) {
    _inherits(ShipPlugin, _Phaser$Plugins$BaseP);
    var _super = _createSuper(ShipPlugin);
    function ShipPlugin(pluginManager) {
      _classCallCheck(this, ShipPlugin);
      return _super.call(this, pluginManager);
    }
    _createClass(ShipPlugin, [{
      key: "start",
      value: function start() {
