(function (global, factory) {
  ...
  var MathWrap = Phaser.Math.Wrap;
  var WrapAngle = Phaser.Math.Angle.Wrap;
  var AngleBetween = Phaser.Math.Angle.Between;
  var RotateTo = /*#__PURE__*/function (_TickTask) {
    _inherits(RotateTo, _TickTask);
    var _super = _createSuper(RotateTo);
    function RotateTo(gameObject, config) {
      var _this;
      _classCallCheck(this, RotateTo);
    ...
    _createClass(RotateTo, [{
      ...
      key: "rotateTo",
      value: function rotateTo(angle, dir, speed) {
      ...
      key: "rotateTowardsPosition",
      value: function rotateTowardsPosition(x, y, dir, speed) {
  ...
  var diffAngle = function diffAngle(a0, a1, cw) {
  ...
  var RotateToPlugin = /*#__PURE__*/function (_Phaser$Plugins$BaseP) {
    _inherits(RotateToPlugin, _Phaser$Plugins$BaseP);
    var _super = _createSuper(RotateToPlugin);
    function RotateToPlugin(pluginManager) {
      _classCallCheck(this, RotateToPlugin);
      return _super.call(this, pluginManager);
    }
    _createClass(RotateToPlugin, [{
      key: "start",
      value: function start() {
